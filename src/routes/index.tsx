...
import { Select as SelectRoot, SelectItem, SelectValue, SelectTrigger, SelectContent } from "~/components/ui/select";
                        ...
                        <SelectRoot<string>
                            ...
                            itemComponent={(props) => (
                                <SelectItem
                                    item={props.item}
                                    class={cn({
                                        "bg-accent text-accent-foreground": filters.tags.includes(props.item.rawValue),
                                    })}>
                                                ...
                                                <For each={state.selectedOptions()}>
                                                    {(option) => (
                                                        <span
                                                            ...
                                                            class={"bg-neutral-800 px-2 py-1 rounded flex gap-1"}>
                                                            {option}
